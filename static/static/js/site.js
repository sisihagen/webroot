...
$(document).ready(function () {
    var displaylimit = 5;
    var twitterprofile = "silviosiefke";
    var screenname = "Silvio Siefke";
  ...
  var headerHTML = '';
  var loadingHTML = '';
  headerHTML += '<div class="tweet-start"><a href="https://twitter.com/" target="_blank"><svg class="icon icon-twitter"><use xlink:href="/static/img/symbol-defs.svg#icon-twitter"></use></svg></a>';
  headerHTML += '<a href="https://twitter.com/'+twitterprofile+'" target="_blank">@'+twitterprofile+'</a></div>';
  loadingHTML += '<div id="loading-container"><div id="floatingBarsG"><div class="blockG" id="rotateG_01"></div><div class="blockG" id="rotateG_02"></div><div class="blockG" id="rotateG_03"></div><div class="blockG" id="rotateG_04"></div><div class="blockG" id="rotateG_05"></div><div class="blockG" id="rotateG_06"></div><div class="blockG" id="rotateG_07"></div><div class="blockG" id="rotateG_08"></div></div></div>';

  $('#twitter-feed').html(headerHTML + loadingHTML);

    $.getJSON('/static/twitter.json',
        function(feeds) {
       //alert(feeds);
            var feedHTML = '';
        ...
        //console.log(feeds[i]);
         ...
         if (((showretweets == true) || ((isaretweet == false) && (showretweets == false))) && ((showdirecttweets == true) || ((showdirecttweets == false) && (isdirect == false)))) {
          if ((feeds[i].text.length > 1) && (displayCounter <= displaylimit)) {
            ...
            feedHTML += '<div class="twitter-pic"><a href="https://twitter.com/'+tweetusername+'" target="_blank"><img src="'+profileimage+'"/static/img/twitter-feed-icon.png" width="42" height="42" alt="twitter icon" /></a></div>';
  ...
  var authors = [
      ...
      setHtml = function(q) {
         $('#quote').html(
              "<blockquote class='quote-text'><p>"+ q.quote +"</p>" +
              "<p class='text-micro'> - "+ q.titles +"</p>" +
              "</blockquote>"
         );
      },
      colorUI = function(color) {
          color = randColor();
          $('body').css({
          });
